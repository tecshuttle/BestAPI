...
<script src="/js/admin/supplier/supplier_grid.js"></script>
<script src="/js/admin/supplier/supplier_form.js"></script>
<script src="/js/admin/supplier/supplier.js"></script>
