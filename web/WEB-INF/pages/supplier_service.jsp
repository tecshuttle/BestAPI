...
<script src="/js/admin/supplier/supplier_service_grid.js"></script>
<script src="/js/admin/supplier/supplier_service_form.js"></script>
<script src="/js/admin/supplier/supplier_service.js"></script>
