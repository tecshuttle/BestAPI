...
<script src="/js/admin/card/card_no_gen_batch_grid.js"></script>
<script src="/js/admin/card/card_no_gen_batch_form.js"></script>
<script src="/js/admin/card/card_no_gen_form.js"></script>
<script src="/js/admin/card/card_no_gen.js"></script>
